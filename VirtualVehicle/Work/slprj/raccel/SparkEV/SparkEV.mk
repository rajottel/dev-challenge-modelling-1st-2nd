###########################################################################
## Makefile generated for component 'SparkEV'. 
## 
## Makefile     : SparkEV.mk
## Generated on : Fri Jul 14 14:19:34 2023
## Final product: ./SparkEV.exe
...
MODELREF_LINK_RSPFILE     = SparkEV_ref.rsp
COMPILER_COMMAND_FILE     = SparkEV_comp.rsp
CMD_FILE                  = SparkEV.rsp
...
DEFINES_STANDARD = -DMODEL=SparkEV -DNUMST=5 -DNCSTATES=40 -DHAVESTDIO
...
MODELREF_LIBS = C:/Users/Thomas/Documents/EcoCAR/Dev\ Challenge/Model/1st-year/VirtualVehicle/Work/slprj/sim/DriverPassThrough/DriverPassThroughlib.lib C:/Users/Thomas/Documents/EcoCAR/Dev\ Challenge/Model/1st-year/VirtualVehicle/Work/slprj/sim/EvPowertrainController/EvPowertrainControllerlib.lib C:/Users/Thomas/Documents/EcoCAR/Dev\ Challenge/Model/1st-year/VirtualVehicle/Work/slprj/sim/OpenLoopBraking/OpenLoopBrakinglib.lib
...
%.obj : $(START_DIR)/slprj/raccel/SparkEV/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/SparkEV/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
SparkEV.obj : $(START_DIR)/slprj/raccel/SparkEV/SparkEV.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SparkEV_capi.obj : $(START_DIR)/slprj/raccel/SparkEV/SparkEV_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SparkEV_data.obj : $(START_DIR)/slprj/raccel/SparkEV/SparkEV_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SparkEV_tgtconn.obj : $(START_DIR)/slprj/raccel/SparkEV/SparkEV_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
