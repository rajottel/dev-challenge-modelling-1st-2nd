...
#define S_FUNCTION_NAME DriverPassThrough_msf
#endif
...
am5nrfreizz * dw = ( am5nrfreizz * ) ssGetDWork ( S , 0 ) ; real_T const *
i_frrxbql4f5 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T * o_B_1_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid == 0 ) {
DriverPassThrough ( i_frrxbql4f5 , o_B_1_1 ) ; } } static void
...
mr_DriverPassThrough_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S
...
mr_DriverPassThrough_MdlInfoRegFcn ( S , "DriverPassThrough" , & retVal ) ;
if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( am5nrfreizz ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { am5nrfreizz * dw = (
am5nrfreizz * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } lkghv3zku5
...
* S , int_T tid ) { am5nrfreizz * dw = ( am5nrfreizz * ) ssGetDWork ( S , 0 )
; real_T const * i_frrxbql4f5 = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid !=
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { DriverPassThrough (
i_frrxbql4f5 , o_B_1_1 ) ; } } static void mdlTerminate ( SimStruct * S ) {
am5nrfreizz * dw = ( am5nrfreizz * ) ssGetDWork ( S , 0 ) ; labuig2vc2 ( & (
dw -> rtm ) ) ; return ; }
...
mdlrefDW = mr_DriverPassThrough_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_DriverPassThrough_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber (
...
mr_DriverPassThrough_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber (
