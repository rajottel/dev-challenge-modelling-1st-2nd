###########################################################################
## Makefile generated for component 'EvPowertrainController'. 
## 
## Makefile     : EvPowertrainController.mk
## Generated on : Fri Jul 14 12:32:49 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/EvPowertrainController_msf.mexw64
...
PRODUCT_NAME              = EvPowertrainController
MAKEFILE                  = EvPowertrainController.mk
...
COMPILER_COMMAND_FILE     = EvPowertrainController_comp.rsp
CMD_FILE                  = EvPowertrainController.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/EvPowertrainController_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=EvPowertrainController -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/EvPowertrainController/EvPowertrainController_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = EvPowertrainController_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/Thomas/Documents/EcoCAR/Dev\ Challenge/Model/1st-year/VirtualVehicle/Work/slprj/sim/EvPowertrainController/EvPowertrainControllerlib.lib
...
EvPowertrainController_msf.obj : $(START_DIR)/slprj/sim/EvPowertrainController/EvPowertrainController_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
