###########################################################################
## Makefile generated for component 'OpenLoopBraking'. 
## 
## Makefile     : OpenLoopBraking.mk
## Generated on : Wed Jul 12 15:57:32 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/OpenLoopBraking_msf.mexw64
...
MODELREF_LINK_RSPFILE     = OpenLoopBraking_ref.rsp
COMPILER_COMMAND_FILE     = OpenLoopBraking_comp.rsp
CMD_FILE                  = OpenLoopBraking.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/OpenLoopBraking_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=OpenLoopBraking -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/OpenLoopBraking/OpenLoopBraking_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = OpenLoopBraking_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/Users/Thomas/Documents/EcoCAR/Dev\ Challenge/Model/VirtualVehicle/VirtualVehicle/Work/slprj/sim/OpenLoopBraking/OpenLoopBrakinglib.lib
...
OpenLoopBraking_msf.obj : $(START_DIR)/slprj/sim/OpenLoopBraking/OpenLoopBraking_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
