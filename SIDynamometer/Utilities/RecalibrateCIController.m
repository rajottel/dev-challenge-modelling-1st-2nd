...
if ~doplot || docal
    ...
    % Save Changes
    saveDD(ddobjs([1,3,4]));
    save_system(bdroot(ResultsBlkName),'SaveDirtyReferencedModels',true);
end
...
%This function saves the data dictionary for plant and controller
function saveDD(ddobjs)
